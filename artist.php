...
if(isset($_POST['submit']))
{
  ...
  $contact=$_POST['contact'];
    ...
    $sql="INSERT INTO `upload`(Uname,image,category,description,dimension,price,mail,mobnum) VALUES('$name','$file','$category','$description','$dimension','$price','$emailid','$contact')";
